...
export const getInvitationStatistics = createAction('GET_JOBS_INVITATIONS_STATISTICS', jobs.getInvitationStatistics)
...
export const clearStatistics = createAction('CLEAR_STATISTICS')
